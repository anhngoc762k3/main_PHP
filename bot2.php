...
if (isset($_POST['question'])) {
    ...
    $pythonScriptPath = 'F:\\xampp\\htdocs\\MAIN_php\\bot2.py';

    if (file_exists($pythonScriptPath)) {
        $command = escapeshellcmd("python F:\\xampp\\htdocs\\MAIN_php\\bot2.py '" . escapeshellarg($question) . "'");
...
<body>
    ...
    <div class="header">CHATBOT AI - NGUYEN ANH NGOC</div>
        <div class="content">
            <h1>Chào mừng bạn đến với hệ thống chatbot AI giáo dục hỗ trợ kiểm tra và đánh giá!</h1>
    ...
    <script>
        ...
        async function fetchResponse(question) {
            let response = await fetch('http://localhost:8080/MAIN_php/bot2.php', {
                method: 'POST',
                headers: {
